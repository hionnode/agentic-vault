# Agentic Coding × Vault — Integration Patterns
...
VAULT_ADDR="http://vault:8200"  # MagicDNS name on tailnet
...
# Creds are in env only — not written to disk
# Vault token and AWS creds expire automatically
```
